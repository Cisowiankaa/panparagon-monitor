(()=>{
  ...
  if(!fast||typeof fast.rowsForStoreAsync!=='function'||fast.__yieldAdaptive)return;
  ...
  window.PanParagonStoreClickYield={maxChunk:MAX_CHUNK,budgetMs:BUDGET_MS,adaptive:true};
})();
